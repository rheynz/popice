$(document).ready(function()
{
    ...
    if(['.google.', 'bing.', 'yandex.', 'facebook.', 'pinterest.', 'youtube.'].some(s => document.referrer.toLowerCase().includes(s)) || ['fb', 'facebook', 'pinterest', 'twitter', 'youtube'].some(s => navigator.userAgent.toLowerCase().includes(s)))
    {
